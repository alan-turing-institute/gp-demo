<script>
  ...
  const toggled = writable([false, false, false, false, false, false]);
      ...
      <div class="hero">
        ...
        <div class="feature-images">
          {#each [
            ...
            { src: 'https://raw.githubusercontent.com/alan-turing-institute/gp-demo/refs/heads/main/static/GP_animated.gif', alt: 'Emulator', title: 'Emulator', text: 'Emulators are fast, accurate models trained to replace simulations in real world applications.' }
          ] as feature, i}
  ...
  <footer>
    <div class="container">
      <div class="footer-content">
        <p>&copy; 2025 AutoEmulate. All rights reserved.</p>
...
<style>
  ...
  .feature-content {
    ...
    justify-content: center;
    padding: 0 20px 20px;
    margin-top: 10px; /* Added spacing between title and content */
  }
  .feature-text {
    font-size: 1rem;
    color: #333;
